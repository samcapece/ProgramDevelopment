  ...
  try {
    api.onmessage = function (msg, data) {
      if ("event" in data) {
        ...
        // Add the notification event handling here
        if (data.event == "NotificationEvent") {
...
function displayNotification(message) {
  ...
  notification.className = 'notification-item'; // This class should be defined in your CSS
